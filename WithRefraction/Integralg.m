function f = Integralg(kr,c,Ref,gamma,r_0,Ru,n1,n,m)
...
% generation.
    ...
    f1 = r1.^1.5.*besselj(n+0.5,Ru(n+1,m).*r1).*legendreP(n,mu1).*g(kr,c,Ref,gamma,r_0,n1,r1,mu1).*dmu1;
    f2 = r2.^1.5.*besselj(n+0.5,Ru(n+1,m).*r2).*legendreP(n,mu2).*g(kr,c,Ref,gamma,r_0,n1,r2,mu2).*dmu2;
    f3 = r3.^1.5.*besselj(n+0.5,Ru(n+1,m).*r3).*legendreP(n,mu3).*g(kr,c,Ref,gamma,r_0,n1,r3,mu3).*dmu3;
    f4 = r4.^1.5.*besselj(n+0.5,Ru(n+1,m).*r4).*legendreP(n,mu4).*g(kr,c,Ref,gamma,r_0,n1,r4,mu4).*dmu4;
